    ...
    $('#post-form').submit(function(e) {
        ...
        $.ajax({
            ...
            success: function(e) {
                ...
                <div class="flex justify-between items-center lg:p-4 p-2.5">\
                    <div class="flex flex-1 items-center space-x-4">\
                        <a href="#">\
                            <img src="' + e.post.profile_image + '" class="bg-gray-200 border border-white rounded-full w-10 h-10" />\
                        </a>\
                        <div class="flex-1 font-semibold capitalize">\
                            <a href="#" class="text-black dark:text-gray-100"> ' + e.post.full_name + ' </a>\
                            <div class="text-gray-700 flex items-center space-x-2">\
                                <small>' + e.post.date + ' ago </small>\
                ...
                <div uk-lightbox>\
                    <a href="' + e.post.image + '">\
                        <img src="' + e.post.image + '" alt="" class="max-h-96 w-full object-cover" />\
                    </a>\
                </div>\
                <div class="p-4 space-y-3">\
                    ...
                    <div class="flex items-center space-x-3 pt-2">\
                        <div class="flex items-center">\
                            <img src="{% static "assets/images/avatars/avatar-1.jpg" %}" alt="" class="w-6 h-6 rounded-full border-2 border-white dark:border-gray-900" />\
                            <img src="{% static "assets/images/avatars/avatar-4.jpg" %}" alt="" class="w-6 h-6 rounded-full border-2 border-white dark:border-gray-900 -ml-2" />\
                            <img src="{% static "assets/images/avatars/avatar-2.jpg" %}" alt="" class="w-6 h-6 rounded-full border-2 border-white dark:border-gray-900 -ml-2" />\
                        </div>\
            ...
            '
                ...
                $("#create-post-modal").removeClass("uk-flex uk-upon");
